...
I built (and am improving!) a full stack web app that pulls Boston's live MBTA prediction data and displays it on an interactive map, following MBTA's real time display guidelines!
